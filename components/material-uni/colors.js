...
function getThemeName() {
    return uni.getStorageSync("APP_THEME") || "blue";
}
...
export {setTheme, getTheme, getColor, tabActiveColor, tabInactiveColor, getThemeName};