...
<template>
	<view class="wrap" @longpress="handlePress($event)" @tap="handleTap($event)" :style="{'width':width+'rpx','height':height+'rpx','background':(plain?'#ffffff':color),'border':(plain?'1rpx solid'+color:'0px')}">
